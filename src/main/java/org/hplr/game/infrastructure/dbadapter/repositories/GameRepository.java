...
public interface GameRepository extends CrudRepository<GameEntity, Long> {
    ...
    @Transactional
    @Modifying
    @Query(value="update GameEntity g set g.status=org.hplr.game.core.enums.Status.IN_PROGRESS where g.gameId in :gameToStartIdList")
    ...
    @Transactional
    @Modifying
    @Query(value="update GameEntity g set g.status=org.hplr.game.core.enums.Status.IN_PROGRESS where g.gameId = :gameToStartIdList")
